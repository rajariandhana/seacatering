...
const Footer = ()=>{
  return (
    <footer className="w-full h-fit flex flex-col lg:flex-row bg-white lg:justify-between items-center px-6 lg:px-20 py-4 lg:py-8 text-xs lg:text-sm text-gray-500 gap-4 border-t">
